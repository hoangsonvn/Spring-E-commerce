                            ...
                            <table class="shop-table">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="shop-details">
                                                ...
                                                <p>
                                                    Product Code : <strong class="pcode">${item.value.productDTO.productId}</strong>
                                                </p>
                                            </div>
                                        </td>
                                        <td>
                                            <h5 style="color: #41B314; font-weight: bold;">$${Math.round(item.value.productDTO.price-item.value.productDTO.saleDTO.salePercent*item.value.productDTO.price/100)}.00</h5>
                                            <c:if
                                                    test="${item.value.productDTO.saleDTO.salePercent > 0}">
                                                <p style="font-size: 16px; padding-top: 7px; text-decoration: line-through;">$${item.value.productDTO.price}.00</p>
                                            </c:if>
                                        </td>
                                        <td>
                                            <form action="<c:url value="/client/editcart"/>" method="post">
                                                <select name="quantity" onchange="this.form.submit()">
                                                    ...
                                                    <input type="hidden"
                                                           value="${item.value.productDTO.productId}"
                                                           name="productId" />
                                                </select>
                                            </form>
                                        </td>
                                ...
                                <tr>
                                    <td colspan="6"><a href="<c:url value="/client/home"/>"><button
                                            class="pull-right">Continue Shopping</button></a>
                                </tr>
                                </tfoot>
                            </table>
                            <div class="clearfix"></div>
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <div class="shippingbox">
                                        ...
                                        <c:if test="${sessionScope.user != null}">
                                            <a href="<c:url value="/client/profile"/> "><button>Go To Profile</button></a>
                                        </c:if>
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-6">
