                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="shop-details">
                                                ...
                                                <p>
                                                    Sale : <strong
                                                        class="pcode">-${item.value.productDTO.saleDTO.salePercent}%</strong>
                                                </p>
                                                <p>
                                                    Product Code : <strong
                                                        class="pcode">${item.value.productDTO.productId}</strong>
                                                </p>
                                            </div>
                                        </td>
                                        <td>
                                    ...
                                    <div class="shippingbox">
                                        ...
                                        <c:if
                                            ...
                                            <form action="<c:url value="/client/checkout"/>" method="get">
                                                <button type="submit"
                                                        style="background: #d5d5d5; color: #1a8cff;font-weight: bold">
                                                    Paypal
                                                </button>
                                            </form>
                                            <form action="<c:url value="/client/checkout"/>" method="get">
