...
<div class="error">
    ...
    <br>
    <a href="<c:url value="/client/home"/> " class="error__button error__button--active">Go Client Home</a>
    <a href="<c:url value="/admin/home"/> " class="error__button error__button--active">Go Admin Home</a>
