...
public class ProductDTO {
    ...
    public ProductDTO(long productId, String productName, float price, int quantity, String description, String image,
                      CategoryDTO categoryDTO, SaleDTO saleDTO, Date expirationDate) {
        super();
    ...
    public ProductDTO(String productName, float price, int quantity, String description, String image, CategoryDTO categoryDTO, SaleDTO saleDTO, Date expirationDate) {
        this.productName = productName;
        this.price = price;
        this.quantity = quantity;
        this.description = description;
